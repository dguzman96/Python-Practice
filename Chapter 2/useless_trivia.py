#Useless Trivia
#
#Gets personal information from the user then
...
print("n\Did you know that on the moon you would weigh only",
      moon_weight, "pounds?")

sun_weight= weight * 27.1
print("n\Did you know that on the sun you would weigh only",
      sun_weight, "(but, ah... not for long).")

...
print("2000 - 100 + 50 = ", 200 - 100 + 50)

print("\nIf an adventurer return from a successful quest ad buys each of")
...
print("your friends split it evenly in 4 ways, how much do you each throw in?")
input("Press the enter key to find out.")
print("19 / 4 = ", 19 / 4)

print("\nIf a group of 4 pirates finds a chest full of 107 gold coins, and")
print("they divide the booty evenly, how mnay whole coins does each get?")
input("Press the enter key to find out.")
print("107 // 4 = ", 107 // 4)

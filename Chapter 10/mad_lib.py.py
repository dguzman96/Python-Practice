...
class Application(Frame):
    """GUI Application fthat creates a story based on user input."""
    ...
    def create_widgets(self):
        ...
        #create a label and text entryy for the name of a person
        ...
        Checkbutton(self, text = "joyous", variable = self.is_joyous
              ).grid(row = 4, column = 2, sticky = W)

        #create electric check button
        self.is_electric = BooleanVar()
        Checkbutton(self, text = "electric", variable = self.is_electric

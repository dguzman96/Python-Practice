...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.inst_lbl = Label(self, text = "Enter a password for the secret of longevity")
        ...
        self.pw_ent.grid(row = 2, colum = 1, sticky = W)

        #create submit button
        self.submit_bttn = Button(self, text = "Submit", command = self.reveal)
        self.submit_bttn.grid(row = 2, column = 0, sticky = W)

        #create texxt widget to display message
        self.secret_txt = Text(self, width = 35, height = 5, wrap = WORD)
        self.secret_txt.grid(row = 3, colum = 0, columnspan = 2 sticky = W)
        ...
        def reveal(self):
            ...
            if contents == "secret":
                message = "Here's the secret to living to 100: libe to 99 " \
